...
Auth + Kullanıcı/Skill/Role CRUD + Chat Bot temel akışı + Bütçe Yönetimi + MCP tool çağrısı (http_api, gerçek Anthropic key ile uçtan uca doğrulandı) tamamlandı. Sırada, öncelik sırasına göre:
